...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("------Recorrer LinkedList con ForEach---------");
        ...
        System.out.println("------Recorrer LinkedHashSet con ForEach---------");
        ...
        System.out.println("------Recorrer HashMap con ForEach---------");
        ...
        System.out.println("------Recorrer LinkedHashMap con ForEach---------");
        ...
        System.out.println("------Recorrer TreeMap con ForEach---------");
